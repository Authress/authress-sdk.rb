...
# Unit tests for SwaggerClient::AccessRecordsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessRecordsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessRecordsApi.new
  end
  ...
  describe 'test an instance of AccessRecordsApi' do
    it 'should create an instance of AccessRecordsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessRecordsApi)
    end
  end
