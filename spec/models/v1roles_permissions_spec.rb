...
# Unit tests for SwaggerClient::V1rolesPermissions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1rolesPermissions' do
  before do
    # run before each test
    @instance = SwaggerClient::V1rolesPermissions.new
  end
  ...
  describe 'test an instance of V1rolesPermissions' do
    it 'should create an instance of V1rolesPermissions' do
      expect(@instance).to be_instance_of(SwaggerClient::V1rolesPermissions)
    end
  end
