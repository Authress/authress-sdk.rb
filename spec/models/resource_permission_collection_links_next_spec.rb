...
# Unit tests for SwaggerClient::ResourcePermissionCollectionLinksNext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcePermissionCollectionLinksNext' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcePermissionCollectionLinksNext.new
  end
  ...
  describe 'test an instance of ResourcePermissionCollectionLinksNext' do
    it 'should create an instance of ResourcePermissionCollectionLinksNext' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcePermissionCollectionLinksNext)
    end
  end
