...
# Unit tests for SwaggerClient::V1clientsOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1clientsOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::V1clientsOptions.new
  end
  ...
  describe 'test an instance of V1clientsOptions' do
    it 'should create an instance of V1clientsOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::V1clientsOptions)
    end
  end
