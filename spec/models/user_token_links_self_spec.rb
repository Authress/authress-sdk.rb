...
# Unit tests for SwaggerClient::UserTokenLinksSelf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTokenLinksSelf' do
  before do
    # run before each test
    @instance = SwaggerClient::UserTokenLinksSelf.new
  end
  ...
  describe 'test an instance of UserTokenLinksSelf' do
    it 'should create an instance of UserTokenLinksSelf' do
      expect(@instance).to be_instance_of(SwaggerClient::UserTokenLinksSelf)
    end
  end
