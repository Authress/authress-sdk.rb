...
# Unit tests for SwaggerClient::V1recordsLinksSelf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1recordsLinksSelf' do
  before do
    # run before each test
    @instance = SwaggerClient::V1recordsLinksSelf.new
  end
  ...
  describe 'test an instance of V1recordsLinksSelf' do
    it 'should create an instance of V1recordsLinksSelf' do
      expect(@instance).to be_instance_of(SwaggerClient::V1recordsLinksSelf)
    end
  end
