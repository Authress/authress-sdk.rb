...
# Unit tests for SwaggerClient::AccessRecordCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessRecordCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessRecordCollection.new
  end
  ...
  describe 'test an instance of AccessRecordCollection' do
    it 'should create an instance of AccessRecordCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessRecordCollection)
    end
  end
