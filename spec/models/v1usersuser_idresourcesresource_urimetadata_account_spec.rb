...
# Unit tests for SwaggerClient::V1usersuserIdresourcesresourceUrimetadataAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1usersuserIdresourcesresourceUrimetadataAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::V1usersuserIdresourcesresourceUrimetadataAccount.new
  end
  ...
  describe 'test an instance of V1usersuserIdresourcesresourceUrimetadataAccount' do
    it 'should create an instance of V1usersuserIdresourcesresourceUrimetadataAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::V1usersuserIdresourcesresourceUrimetadataAccount)
    end
  end
