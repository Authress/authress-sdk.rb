...
# Unit tests for SwaggerClient::ClientCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::ClientCollection.new
  end
  ...
  describe 'test an instance of ClientCollection' do
    it 'should create an instance of ClientCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::ClientCollection)
    end
  end
