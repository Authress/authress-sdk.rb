...
# Unit tests for SwaggerClient::V1usersuserIdtokensResources
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1usersuserIdtokensResources' do
  before do
    # run before each test
    @instance = SwaggerClient::V1usersuserIdtokensResources.new
  end
  ...
  describe 'test an instance of V1usersuserIdtokensResources' do
    it 'should create an instance of V1usersuserIdtokensResources' do
      expect(@instance).to be_instance_of(SwaggerClient::V1usersuserIdtokensResources)
    end
  end
