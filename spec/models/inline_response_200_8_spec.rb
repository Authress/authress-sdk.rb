...
# Unit tests for AuthressSdk::InlineResponse2008

# Please update as you see appropriate
describe 'InlineResponse2008' do
  before do
    # run before each test
    @instance = AuthressSdk::InlineResponse2008.new
  end
  ...
  describe 'test an instance of InlineResponse2008' do
    it 'should create an instance of InlineResponse2008' do
      expect(@instance).to be_instance_of(AuthressSdk::InlineResponse2008)
    end
  end
