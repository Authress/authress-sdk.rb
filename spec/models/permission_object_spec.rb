...
# Unit tests for SwaggerClient::PermissionObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PermissionObject' do
  before do
    # run before each test
    @instance = SwaggerClient::PermissionObject.new
  end
  ...
  describe 'test an instance of PermissionObject' do
    it 'should create an instance of PermissionObject' do
      expect(@instance).to be_instance_of(SwaggerClient::PermissionObject)
    end
  end
