...
# Unit tests for SwaggerClient::IdentityCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdentityCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::IdentityCollection.new
  end
  ...
  describe 'test an instance of IdentityCollection' do
    it 'should create an instance of IdentityCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::IdentityCollection)
    end
  end
