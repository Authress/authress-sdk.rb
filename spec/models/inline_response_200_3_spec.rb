...
# Unit tests for AuthressSdk::InlineResponse2003

# Please update as you see appropriate
describe 'InlineResponse2003' do
  before do
    # run before each test
    @instance = AuthressSdk::InlineResponse2003.new
  end
  ...
  describe 'test an instance of InlineResponse2003' do
    it 'should create an instance of InlineResponse2003' do
      expect(@instance).to be_instance_of(AuthressSdk::InlineResponse2003)
    end
  end
