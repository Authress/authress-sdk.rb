...
# Unit tests for SwaggerClient::V1usersuserIdtokensStatements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1usersuserIdtokensStatements' do
  before do
    # run before each test
    @instance = SwaggerClient::V1usersuserIdtokensStatements.new
  end
  ...
  describe 'test an instance of V1usersuserIdtokensStatements' do
    it 'should create an instance of V1usersuserIdtokensStatements' do
      expect(@instance).to be_instance_of(SwaggerClient::V1usersuserIdtokensStatements)
    end
  end
