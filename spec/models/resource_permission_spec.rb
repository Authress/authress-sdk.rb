...
# Unit tests for SwaggerClient::ResourcePermission
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcePermission' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcePermission.new
  end
  ...
  describe 'test an instance of ResourcePermission' do
    it 'should create an instance of ResourcePermission' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcePermission)
    end
  end
