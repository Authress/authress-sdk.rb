...
# Unit tests for SwaggerClient::V1recordsAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1recordsAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::V1recordsAccount.new
  end
  ...
  describe 'test an instance of V1recordsAccount' do
    it 'should create an instance of V1recordsAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::V1recordsAccount)
    end
  end
