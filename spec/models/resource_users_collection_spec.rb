...
# Unit tests for SwaggerClient::ResourceUsersCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourceUsersCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourceUsersCollection.new
  end
  ...
  describe 'test an instance of ResourceUsersCollection' do
    it 'should create an instance of ResourceUsersCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourceUsersCollection)
    end
  end
