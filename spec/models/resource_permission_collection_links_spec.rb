...
# Unit tests for SwaggerClient::ResourcePermissionCollectionLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcePermissionCollectionLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcePermissionCollectionLinks.new
  end
  ...
  describe 'test an instance of ResourcePermissionCollectionLinks' do
    it 'should create an instance of ResourcePermissionCollectionLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcePermissionCollectionLinks)
    end
  end
