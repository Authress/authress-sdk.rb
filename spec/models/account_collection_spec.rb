...
# Unit tests for SwaggerClient::AccountCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountCollection.new
  end
  ...
  describe 'test an instance of AccountCollection' do
    it 'should create an instance of AccountCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountCollection)
    end
  end
