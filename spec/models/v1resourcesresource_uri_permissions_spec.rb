...
# Unit tests for SwaggerClient::V1resourcesresourceUriPermissions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1resourcesresourceUriPermissions' do
  before do
    # run before each test
    @instance = SwaggerClient::V1resourcesresourceUriPermissions.new
  end
  ...
  describe 'test an instance of V1resourcesresourceUriPermissions' do
    it 'should create an instance of V1resourcesresourceUriPermissions' do
      expect(@instance).to be_instance_of(SwaggerClient::V1resourcesresourceUriPermissions)
    end
  end
