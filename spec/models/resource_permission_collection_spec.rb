...
# Unit tests for SwaggerClient::ResourcePermissionCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcePermissionCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcePermissionCollection.new
  end
  ...
  describe 'test an instance of ResourcePermissionCollection' do
    it 'should create an instance of ResourcePermissionCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcePermissionCollection)
    end
  end
