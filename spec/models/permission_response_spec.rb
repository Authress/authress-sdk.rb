...
# Unit tests for SwaggerClient::PermissionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PermissionResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PermissionResponse.new
  end
  ...
  describe 'test an instance of PermissionResponse' do
    it 'should create an instance of PermissionResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PermissionResponse)
    end
  end
