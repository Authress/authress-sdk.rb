...
# Unit tests for AuthressSdk::InlineResponse2004

# Please update as you see appropriate
describe 'InlineResponse2004' do
  before do
    # run before each test
    @instance = AuthressSdk::InlineResponse2004.new
  end
  ...
  describe 'test an instance of InlineResponse2004' do
    it 'should create an instance of InlineResponse2004' do
      expect(@instance).to be_instance_of(AuthressSdk::InlineResponse2004)
    end
  end
