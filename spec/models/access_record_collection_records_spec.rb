...
# Unit tests for SwaggerClient::AccessRecordCollectionRecords
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessRecordCollectionRecords' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessRecordCollectionRecords.new
  end
  ...
  describe 'test an instance of AccessRecordCollectionRecords' do
    it 'should create an instance of AccessRecordCollectionRecords' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessRecordCollectionRecords)
    end
  end
