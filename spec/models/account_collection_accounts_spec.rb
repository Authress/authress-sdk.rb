...
# Unit tests for SwaggerClient::AccountCollectionAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountCollectionAccounts' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountCollectionAccounts.new
  end
  ...
  describe 'test an instance of AccountCollectionAccounts' do
    it 'should create an instance of AccountCollectionAccounts' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountCollectionAccounts)
    end
  end
