...
# Unit tests for SwaggerClient::ResourcePermissionCollectionResources
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcePermissionCollectionResources' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcePermissionCollectionResources.new
  end
  ...
  describe 'test an instance of ResourcePermissionCollectionResources' do
    it 'should create an instance of ResourcePermissionCollectionResources' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcePermissionCollectionResources)
    end
  end
