...
# Unit tests for SwaggerClient::ClientCollectionClients
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientCollectionClients' do
  before do
    # run before each test
    @instance = SwaggerClient::ClientCollectionClients.new
  end
  ...
  describe 'test an instance of ClientCollectionClients' do
    it 'should create an instance of ClientCollectionClients' do
      expect(@instance).to be_instance_of(SwaggerClient::ClientCollectionClients)
    end
  end
