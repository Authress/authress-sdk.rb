...
# Unit tests for AuthressSdk::AccessRecord

# Please update as you see appropriate
describe 'AccessRecord' do
  before do
    # run before each test
    @instance = AuthressSdk::AccessRecord.new
  end
  ...
  describe 'test an instance of AccessRecord' do
    it 'should create an instance of AccessRecord' do
      expect(@instance).to be_instance_of(AuthressSdk::AccessRecord)
    end
  end
